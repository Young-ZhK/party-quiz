...
(function() {{
    ...
    setInterval(ensureOnTop, 500); // 每0.5秒检查一次
    ...
    console.log('✅ 悬浮窗已打开！可拖动、可最小化、永远在最上层！');
}})();
"""
...
print()
print("新特性：")
print("- 使用 !important 强制样式不被覆盖")
print("- 每0.5秒自动检查，确保在最上层（z-index 最大）")
print("- 即使页面内容变化，也会一直在上面")
print("- 再次运行会先移除旧的，避免重复")
